...
DEFAULT_MATCH_DATA = {
    ...
    'history': [],
    'logs': [],
    'players_a_list': ['ตัวจริง A1 (เสิร์ฟ)', 'ตัวจริง A2', 'ตัวจริง A3', 'ตัวจริง A4', 'ตัวจริง A5', 'ตัวจริง A6'],
    'players_b_list': ['ตัวจริง B1 (เสิร์ฟ)', 'ตัวจริง B2', 'ตัวจริง B3', 'ตัวจริง B4', 'ตัวจริง B5', 'ตัวจริง B6'],
...
# 🏐 หมุนตำแหน่งตามกติกา (1->6->5->4->3->2->1)
...
def add_score(team):
    ...
    # 🏐 หมุนตำแหน่งเฉพาะตอนได้เปลี่ยนเสิร์ฟ (Side-out)
    if m['server'] != team:
        m['server'] = team
        rotate_team_cw(team)
...
# 🔵 TEAM A FIELD (ซ้าย: ท้ายสนาม | ขวา: ติดหน้าเน็ต)
with field_col1:
    st.markdown(f"### {m['team_a']} {'🏐' if m['server'] == 'a' else ''}")
    st.caption("👈 ท้ายสนาม | ติดหน้าเน็ต 👉")
...
# 🔴 TEAM B FIELD (ซ้าย: ติดหน้าเน็ต | ขวา: ท้ายสนาม)
with field_col2:
    st.markdown(f"### {m['team_b']} {'🏐' if m['server'] == 'b' else ''}")
    st.caption("👈 ติดหน้าเน็ต | ท้ายสนาม 👉")
